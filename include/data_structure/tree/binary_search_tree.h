...
public:
     ...
     */
    [[nodiscard]] typename binary_tree<T, D>::ConstIterator begin(traversal type = PREORDER) const;
     ...
     */
    [[nodiscard]] typename binary_tree<T, D>::ConstIterator end(traversal type = PREORDER) const;
...
protected:
     ...
     */
    void rotate_left(typename binary_tree<T, D>::tree_node *node);
     ...
     * @param node The node to rotate.
     */
    void rotate_right(typename binary_tree<T, D>::tree_node *node);
};
